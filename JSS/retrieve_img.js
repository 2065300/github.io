document.addEventListener('DOMContentLoaded', function() {
  //searching for the img class:
    ...
    const imageSources = {
        ...
        '3': {
          src: './Img/horizontalphotos/EndofTheHallway.jpg',
          bg:"#141311", h1:"Light at the end of the hallway", p:"De man zit op een vensterbank van een groot  boograam op het einde van een smalle slecht verlichte hal. De muren zijn gemaakt van oude steen en zijn langzaam aan het verslechteren. Hij haalt diep adem en sluit zijn ogen, terwijl hij de warme zonnestralen op zijn huid voelt. Het is een lange, donkere reis voor hem geweest.\n\n Deze foto herinnert ons er krachtig aan dat hoe moeilijk het leven ook kan zijn, er aan het einde van de reis altijd hoop en licht op ons wacht. Het is aan ons om vooruit te blijven gaan, zelfs op de donkerste momenten.", creator:"In samenwerking met Loek Lutgens"
        },
        '4': {
          src: './Img/horizontalphotos/JungleBook-cropped.jpg',
          bg:"#141311" , h1:"Het verkennen van de wildernis", p:"De man staat midden op de weg, omringd door het weelderige groen van het bos. Hij is een avonturier, een reiziger die de wildernis wil verkennen en de schoonheid ervan op film wil vastleggen. \n\nDe camera in zijn hand is zijn gereedschap en de rugzak op zijn rug bevat zijn voorraden. Hij leeft met de sensatie van ontdekking en het wonder van het onbekende. Deze foto vangt een moment van vrijheid en het nastreven van iemands passie.  ", creator:"In samenwerking met Loek Lutgens"
        },
        '5': {
        ...
        '6': {
          src: './Img/horizontalphotos/a-new-beginning-cropped.jpg',
          bg:"#141311", h1:"A new beginning", p:"De man staat zelfverzekerd op de weelderige vegetatie en geniet van de adembenemende zonsondergang voor hem. De kleurrijke foto vangt de zonnestralen op terwijl ze de omgeving verlichten, waardoor het tafereel een warm een mysterieuze gloed krijgt. De man is volledige ondergedompeld in de natuur, met slechts een vleugje menselijk ingrijpen op de achtergrond.\n\n Dit beeld is een krachtig symbool van hoop en een nieuw begin. Het herinnert ons eraan dat, hoe moeilijk dingen ook lijken, er altijd een nieuw hoofdstuk wacht om zich te ontvouwen. Het kiezen van het minder bewandelede pad kan een avontuur vol onzekerheid zijn, maar de beloningen zijn onbetaalbaar: de warmte van de zon, de schoonheid van nieuwe leven en de geruststelling dat we in staat zijn een beter toekomst te creëren.", creator:"In samenwerking met Loek Lutgens"
        },
        '7': {
        ...
        '14': {
          src: './Img/verticalphotos/een-krant-lezen-croppedjpg.jpg',
          bg:"#141311", h1:"Fuck de krant", p:"De man zat op het overwoekerde treinspoor, met een krant in zijn handen. Hij keek naar de krantenkoppen en voelde het gewicht van de wereldproblemen op zijn schouders onderdrukken. \n\nMet een verrassende uitbarsting van woede stak hij het papier in brand. Terwijl de vlammen de negatieve woorden verteerden, voelde de man een gevoel van bevrijding. Hij heeft ontdekt dat hij geen passieve waarnemer van de wereldproblemen is. Hij kon actie ondernemen, stap voor stap. De man keek een tijdje naar de smeulende rust van de krant en glimlachte. hij was nu vrij van de negativiteit die hij eerder had gevoeld. Hij stond op en stofte zijn broek af, terwijl hij wegliep van het brandende papier.", creator:""
        },
        '15': {
        ...
        '16': {
          src: './Img/verticalphotos/vergeten-heiligdom.jpg',
          bg:"#1b1610", h1:"Vergeten heiligdom", p:"Het verlaten gebouw staat in de vergrijzing, de eens zo grootse architectuur is nu overwoekerd met planten. Het lange verticale raam, met zijn boog erboven, is nu een poort naar een heiligdom van de natuur. De zon gaat onder en werpt een warme gloed op de bladeren die het raam bedekt.\n\n Een persoon zit op de vensterbank, kijkt uit naar de takken en neemt de schoonheid van dit vergeten heiligdom in zich op. De witte rook die van de grond naar het dak opstijgt, voortvloeit uit een griezelig element toe aan de scène en verwijst naar een mysterie uit het verleden. Deze foto legt het contrast vast tussen de mens gemaakt en de natuur", creator:"In samenwerking met Loek Lutgens"
        },
        '17': {
